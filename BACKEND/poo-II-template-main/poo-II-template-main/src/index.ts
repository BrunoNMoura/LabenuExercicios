...
app.get("/users", async (req: Request, res: Response) => {
  try {
    ...
    //agora faz parte do UserDatabase
    // let usersDB
...
app.post("/users", async (req: Request, res: Response) => {
  try {
    ...
    await userDatabase.createdUser(newUserDB);
...
app.get("/accounts/:id/balance", async (req: Request, res: Response) => {
  try {
    ...
    const accountDB: TAccountDB | undefined =
      await accountDatabase.findAccountById(id);
...
app.post("/accounts", async (req: Request, res: Response) => {
  try {
    ...
    await accountDatabase.createdAccount(newAccountDB);
...
app.put("/accounts/:id/balance", async (req: Request, res: Response) => {
  try {
    ...
    await accountDatabase.updateAccount(id, newBalance);
